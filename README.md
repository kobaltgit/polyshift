...
4. **Магия:** Прямо возле вашего курсора мыши появится аккуратное полупрозрачное окно, в котором в реальном времени побегут строчки перевода на русский язык!
   > 💡 **Перемещение окна:** Окно перевода можно свободно перемещать по экрану. Для этого зажмите левой кнопкой мыши **значок или текст названия** (в левой части шапки окна) и перетащите в удобное место.
